...
int main(int argc, char **argv)
{
   ...
   printf("Inizio prova scelta compilatore\n");
   ...
   // MVC char * cpProva_cast_const = funzProva_cast_const(cpProva_cast_pvoid);
   char * cpProva_cast_const = (char *) funzProva_cast_const(cpProva_cast_pvoid);
   // MVC cpProva_cast_const = ccpProva_cast_const;
   cpProva_cast_const = (char *) ccpProva_cast_const;
   // end prova cast const

   // begin 005 prova altri cast
   // MVC PBYTE pbProva_cast_pbyte = cpProva_cast_pvoid;
   PBYTE pbProva_cast_pbyte = (PBYTE) cpProva_cast_pvoid;
   // MVC cpProva_cast_const = funzProva_cast_const(cpProva_cast_pvoid);
   ...
   *iProva ++;
   ...
   printf("Fine prova scelta compilatore\n");
