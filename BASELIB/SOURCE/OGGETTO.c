...
#define INCL_DOSMISC
#define INCL_WINATOM
// EMS001 tolgo define INCL_DOSPROCESS che non serve e crea problemi con Windows
...
#include "oggetto.h"
#include "elenco_o.h"
// EMS003 VA non serve #include "scandir.h"
...
ULONG _export TimePart() {
   ...
   /* EMS004 VA il compilatore non riesce a valutare l'espressione
