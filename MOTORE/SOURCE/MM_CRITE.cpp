...
// EMS002
// Sostituitsco tutti i __WIN_FASTCALL con __WIN_FASTCALL
...
// COLLEGAMENTO::CalcolaCosto
//----------------------------------------------------------------------------
void __WIN_FASTCALL COLLEGAMENTO::CalcolaCosto(){
   #undef TRCRTN
   ...
   return;  // EMS003 Win inserito return non presente
};

//----------------------------------------------------------------------------
// T_TRENO::CaricaEValidaTreno
//----------------------------------------------------------------------------
BOOL __WIN_FASTCALL T_TRENO::CaricaEValidaTreno(CLU_BUFR & Buffer,T_CLUST & Clu ){ // Valida e carica i dati di T_TRENO
   #undef TRCRTN
...
// COLLEGAMENTO_DIRETTO::ControllaAttesaValida()
//----------------------------------------------------------------------------
BOOL __WIN_FASTCALL COLLEGAMENTO_DIRETTO::ControllaAttesaValida(){
   #undef TRCRTN
...
//----------------------------------------------------------------------------
int  __WIN_FASTCALL CattivoUsoMezzoDiQualita(MM_SOLUZIONE::TRATTA_TRENO & Tratta){
   #undef TRCRTN
...
//----------------------------------------------------------------------------
void __WIN_FASTCALL SOLUZIONE::CalcolaCosto(){
   #undef TRCRTN
