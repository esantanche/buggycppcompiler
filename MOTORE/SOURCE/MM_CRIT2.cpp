...
static MM_CONTROLLO_RICERCA CR_Minima={
   ...
   30     , // NOQUAL                : Penalita' (assoluta!) per l' uso di un treno di qualita' per meno di meta' del percorso o 250 Km
   ...
   20     , // CAMBIO_SICURO2        : Si considera NON a rischio un cambio con tempo di attesa di almeno CAMBIO_SICURO Minuti
...
static MM_CONTROLLO_RICERCA CR_Media ={
   ...
   // Questi indicatori servono al calcolo del costo assoluto: sono pertanto minori rispetto ai loro analoghi per il calcolo del costo
   10     , // CAMBIO_SICURO2        : Si considera NON a rischio un cambio con tempo di attesa di almeno CAMBIO_SICURO Minuti
...
static MM_CONTROLLO_RICERCA CR_TanteSol ={
   ...
   // Questi indicatori servono al calcolo del costo assoluto: sono pertanto minori rispetto ai loro analoghi per il calcolo del costo
   0     , // CAMBIO_SICURO2        : Si considera NON a rischio un cambio con tempo di attesa di almeno CAMBIO_SICURO Minuti
