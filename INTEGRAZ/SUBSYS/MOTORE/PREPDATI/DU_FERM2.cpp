//----------------------------------------------------------------------------
// DU_FERM2: DUMP M2_FERMV.TMP 
// ( fermate dopo lo split dei treni fatto da ML_STEP7 per avere periodicita' costanti)
//----------------------------------------------------------------------------
...
// Qui va la definizione della struttura
   ...
   WORD Progressivo          ; // KEY: Progressivo fermata (in ambito treno virtuale, Parte da 1)
                               ...
                               // Perche' e' anche foreign key per le periodicita'
...
void main(int argc,char *argv[]){                                                   
   ...
   if(argc < 3){
      puts("Utilizzo: DU_FERMV MinMezzo, MaxMezzo");
      exit(999);
   };

   MinMezzo = atoi(argv[1]);
   MaxMezzo = atoi(argv[2]);
...
// Qui va la definizione dei campi di stampa (la dim deve comprendere lo spazio verso il prossimo campo)
   ...
   MK1( ProgressivoPeriodicita, "5","u","Prog","Per")
...
//----------------------------------------------------------------------------
   ...
   MK2( ProgressivoPeriodicita, "5","u","Prog","Per")
   MK2( Progressivo        , "5","u","Prog","Fer.")
   MK2( Progressivo2       , "5","u","Pr 2","Fer.")
   MK2( Id                 , "6","u","Id","")
   MK2( CCR                , "8","u","CCR","")
   MK2( TrenoFisico        , "6","u","Treno","Fis.")
   // MK2( OraArrivo          , "5","u","Ora","Arr.")
   // MK2( OraPartenza        , "5","u","Ora","Par.")
