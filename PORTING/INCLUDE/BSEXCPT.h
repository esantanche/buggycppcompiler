...
#define XCPT_CONTINUE_SEARCH    0x00000000L      /* exception not handled   */
#define XCPT_CONTINUE_EXECUTION 0xFFFFFFFFL      /* exception handled       */
#define XCPT_CONTINUE_STOP      0x00716668L      /* exception handled by    */
...
#define XCPT_FATAL_EXCEPTION    0xC0000000L
#define XCPT_SEVERITY_CODE      0xC0000000L
#define XCPT_CUSTOMER_CODE      0x20000000L
#define XCPT_FACILITY_CODE      0x1FFF0000L
#define XCPT_EXCEPTION_CODE     0x0000FFFFL

/*  Violation flags in ExceptionInfo */

#define XCPT_UNKNOWN_ACCESS     0x00000000L      /* Unknown access */
#define XCPT_READ_ACCESS        0x00000001L      /* Read access    */
#define XCPT_WRITE_ACCESS       0x00000002L      /* Write access   */
#define XCPT_EXECUTE_ACCESS     0x00000004L      /* Execute access */
#define XCPT_SPACE_ACCESS       0x00000008L      /* Address space access */
#define XCPT_LIMIT_ACCESS       0x00000010L      /* Address space limit violation */
#define XCPT_DATA_UNKNOWN       0xFFFFFFFFL

/*  Signal numbers for XCPT_SIGNAL */

#define XCPT_SIGNAL_INTR        1L
#define XCPT_SIGNAL_KILLPROC    3L
#define XCPT_SIGNAL_BREAK       4L

/*  Portable non-fatal software generated exceptions */

#define XCPT_GUARD_PAGE_VIOLATION       0x80000001L
      /* ExceptionInfo[ 0 ] - Access Code: XCPT_READ_ACCESS
                                           XCPT_WRITE_ACCESS */
      /* ExceptionInfo[ 1 ] - FaultAddr */

#define XCPT_UNABLE_TO_GROW_STACK       0x80010001L

/*  Portable fatal hardware generated exceptions */

#define XCPT_DATATYPE_MISALIGNMENT      0xC000009EL
      /* ExceptionInfo[ 0 ] - Access Code: XCPT_READ_ACCESS
                                           XCPT_WRITE_ACCESS */
      /* ExceptionInfo[ 1 ] - Alignment */
      /* ExceptionInfo[ 2 ] - FaultAddr */

#define XCPT_BREAKPOINT                 0xC000009FL
#define XCPT_SINGLE_STEP                0xC00000A0L
#define XCPT_ACCESS_VIOLATION           0xC0000005L
      /* ExceptionInfo[ 0 ] - Access Code: XCPT_READ_ACCESS
                                           XCPT_WRITE_ACCESS
                                           XCPT_SPACE_ACCESS
                                           XCPT_LIMIT_ACCESS
...
#define XCPT_ILLEGAL_INSTRUCTION        0xC000001CL
#define XCPT_FLOAT_DENORMAL_OPERAND     0xC0000094L
#define XCPT_FLOAT_DIVIDE_BY_ZERO       0xC0000095L
#define XCPT_FLOAT_INEXACT_RESULT       0xC0000096L
#define XCPT_FLOAT_INVALID_OPERATION    0xC0000097L
#define XCPT_FLOAT_OVERFLOW             0xC0000098L
#define XCPT_FLOAT_STACK_CHECK          0xC0000099L
#define XCPT_FLOAT_UNDERFLOW            0xC000009AL
#define XCPT_INTEGER_DIVIDE_BY_ZERO     0xC000009BL
#define XCPT_INTEGER_OVERFLOW           0xC000009CL
#define XCPT_PRIVILEGED_INSTRUCTION     0xC000009DL

/*  Portable fatal software generated exceptions */

#define XCPT_IN_PAGE_ERROR              0xC0000006L
      /* ExceptionInfo[ 0 ] - FaultAddr */

#define XCPT_PROCESS_TERMINATE          0xC0010001L
#define XCPT_ASYNC_PROCESS_TERMINATE    0xC0010002L
      /* ExceptionInfo[ 0 ] - TID of 'terminator' thread */

#define XCPT_NONCONTINUABLE_EXCEPTION   0xC0000024L
#define XCPT_INVALID_DISPOSITION        0xC0000025L

/*  Non-portable fatal exceptions */

#define XCPT_INVALID_LOCK_SEQUENCE      0xC000001DL
#define XCPT_ARRAY_BOUNDS_EXCEEDED      0xC0000093L
#define XCPT_B1NPX_ERRATA_02            0xC0010004L

/*  Misc exceptions */

#define XCPT_UNWIND                     0xC0000026L
#define XCPT_BAD_STACK                  0xC0000027L
#define XCPT_INVALID_UNWIND_TARGET      0xC0000028L

/*  Signal Exceptions */

#define XCPT_SIGNAL                     0xC0010003L
